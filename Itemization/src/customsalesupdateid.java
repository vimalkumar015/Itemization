...
public class customsalesupdateid {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					customsalesupdateid window = new customsalesupdateid();
	...
	private void initialize() {
		...
		frmItemizationSales.setTitle("ITEMIZATION - Custom Sales Update");
		frmItemizationSales.setIconImage(Toolkit.getDefaultToolkit().getImage(customsalesupdateid.class.getResource("/images/itemization_logo.png")));
